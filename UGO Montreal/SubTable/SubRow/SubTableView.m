...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        font = [UIFont fontWithName:@"OpenSans-Semibold" size:16.0f];
...
- (void)configureInsideTableView {
    ...
    insideTableView.separatorInset = UIEdgeInsetsMake(20, 0, 0, 0);
    insideTableView.separatorColor = [UIColor colorWithWhite:( 220/255.0) alpha:1.0];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (count > 0) {
        ...
        [cell setCellBackgroundColor:[UIColor colorWithWhite:1.0 alpha:1.0]];
